function y = input_weights_model(num_columns,npp,N,num_VTA,gain,VTA_gain,un_VTA_gain)
...
for i = 1:num_columns
    ...
    L_ij1(N-num_VTA+1:N,l+1:l+ndd) = un_VTA_gain*spones(sprandn(num_VTA,npp,rho_1)).*eye(num_VTA);
